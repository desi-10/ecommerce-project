...
export default function Header() {
    ...
    return (
        <header className="bg-white lg:sticky top-0 z-10 border-b">
            <Wrapper>
                <div className="py-6 flex items-center gap-4">
                    ...
                    <div className="hidden md:flex flex-1 items-center">
                        <div className="flex w-full">
                            <div className="w-28 border rounded-l-md flex items-center justify-center text-xs text-muted-foreground bg-white">
                                All
                            </div>
                            <Input
