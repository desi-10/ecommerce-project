            ...
            <Wrapper>
                <div className="py-6 md:py-8 grid gap-4 md:grid-cols-[1fr_320px]">
                    ...
                    <div className="relative h-[360px] overflow-hidden border border-neutral-200 group">
                        <Image
                            src={mainProduct?.image || "https://images.unsplash.com/photo-1473968512647-3e447244af8f?auto=format&fit=crop&w=1600&q=80"}
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-center p-6 md:p-10 text-white">
                            ...
                            <p className="mt-3 text-sm opacity-90 max-w-md line-clamp-2">
                                {mainProduct?.description || "Experience the next level of tech with our curated selection of premium gadgets."}
                            </p>
                    ...
                    <div className="grid gap-4">
                        ...
                        <div className="relative h-[170px] overflow-hidden border border-neutral-200 group">
                            <Image
                                src={side1?.image || "https://images.unsplash.com/photo-1512499617640-c2f999098c01?auto=format&fit=crop&w=1000&q=80"}
                            ...
                            <div className="relative z-10 h-full p-5 flex flex-col justify-center text-white">
                                <div className="text-[10px] font-bold uppercase tracking-wider text-blue-300">New Arrival</div>
                        ...
                        <div className="relative h-[170px] overflow-hidden border border-neutral-200 group">
                            <Image
                                src={side2?.image || "https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=1000&q=80"}
                            ...
                            <div className="relative z-10 h-full p-5 flex flex-col justify-center text-white">
                                <div className="text-[10px] font-bold uppercase tracking-wider text-blue-300">Limited Time</div>
                                <div className="mt-1 font-bold leading-snug text-lg">
